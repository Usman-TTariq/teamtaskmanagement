        ...
        {!sent ? (
          ...
          <div className="rounded-2xl bg-white p-6 text-center shadow-2xl">
            ...
            <p className="mb-4 text-xs leading-relaxed text-[#9495A3]">
              Open your email and click the reset link. You can set a new password
              from that page. Check spam and junk if it does not arrive within 2
              minutes. If still nothing, ask Abdullah to generate a reset link from
              Settings.
            </p>
            <Link
              href="/login"
