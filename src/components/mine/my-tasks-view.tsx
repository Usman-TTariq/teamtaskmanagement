...
export function MyTasksView({ profile, tasks }: Props) {
          ...
          <div>
            ...
            <p className="mt-1 text-[11px] font-medium text-[#9495A3]">
              {activeFilter
                ...
                : "Click a stat box above to filter tasks by status."}
            </p>
          </div>
          ...
          {visibleColumns.map((status) => {
            ...
            return (
              <div
                ...
                className="flex min-h-[320px] flex-col bg-[#FAFBFD]"
              >
                ...
                <div className="flex flex-1 flex-col gap-2 p-3">
                  {columnTasks.map((task) => (
                    <MineTaskCard key={task.id} task={task} />
                  ))}
